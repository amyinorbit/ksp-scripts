...
declare function halfstage_boost {
    ...
    stage.
    //wait 1.
    set g_steer to peg_hdg(180, 90-peg_vector_loffset).
...
declare parameter pe to 40.
declare parameter ap to 250.
declare parameter inc to 51.6.
declare parameter u to 50.
declare parameter kick_start is 16.
...
set peg_vector_loffset to 7.
set peg_vector_offset to 15.
